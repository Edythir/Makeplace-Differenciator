...
list2 = (f.read())
f.close()
oldjson = json.loads(list1)
newjson = json.loads(list2)
...
listfurn1= makelist(oldjson, 'interiorFurniture')
listfurn2 = makelist(newjson, 'interiorFurniture')
listfix1 = makelist(oldjson, 'interiorFixture')
listfix2 = makelist(newjson, 'interiorFixture')
listexfurn1 = makelist(oldjson, 'exteriorFurniture')
listexfurn2 = makelist(newjson, 'exteriorFurniture')
listexfix1 = makelist(oldjson, 'exteriorFixture')
listexfix2 = makelist(oldjson, 'exteriorFixture')
...
def differer(list1, list2, type):
    ...
    if type == 1:
        ...
        place = 'Exterior Fixtures: \n\n'
    if list2 == []:
        return [f'{place}There\'s nothing here. \n\n']
    ...
    list3.insert(0,place)
    list3[-1] = list3[-1]+'\n\n'
    debug.append(('Full list of items to be purchased:\n\n'+str(list3)+'\n\n'))
    return list3

list3 = differer(listfurn1, listfurn2, 1)
list3 = list3 + differer(listfix1, listfix2, 2)
list3 = list3 + differer(listexfurn1, listexfurn2, 3)
list3 = list3 + differer(listexfix1, listexfix2, 4)
